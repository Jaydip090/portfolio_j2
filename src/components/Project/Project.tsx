      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/amipatel1708/E-commerce" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>E-commerce</h3>
              <p> Designed and developed a fully functional eCommerce website using  e.g., React Js, HTMLS, CSS, etc., ensuring a responsive and user-friendly interface across all devices. </p>
            </div>
            <footer> <ul className="tech-list"> <li>React js</li> <li>Mongo Db</li> <li>Node Js</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                Oversaw the daily operations of the building, ensuring all facilities, including HVAC, plumbing, and electrical systems, were functioning optimally and met safety regulations.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Jaydip090/Drive_Care" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://drive-care.vercel.app/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>ERP System</h3>
              <p>Led the development and implementation of an ERP system.Collaborated with cross-functional teams including finance, supply chain, and HR to gather and document
                requirements.</p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>The Airline Booking System Website is an online platform designed to facilitate the smooth and efficient
                booking of airline tickets for traveler.The website Provide a search functionality for users to find available flights based on departure and destination
                cities,dates,and other filters.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>PHP</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
              Led the planning and execution of various events, including conferences, corporate meetings, and social gatherings, ensuring all aspects were meticulously organized and aligned with client expectations.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
